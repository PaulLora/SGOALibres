        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="intro-message">
                    <h1>SGOA</h1>
                    <h3>Sistema de Gestión de Objetos de Aprendizaje</h3>
                    <hr class="intro-divider">
                    <ul class="list-inline intro-social-buttons"> <!-- http://www.aqu.cat/doc/doc_22391979_1.pdf -->
                        <li><a href="storage/conocer_mas.pdf" target="_blank" class="btn btn-default btn-lg"><i class="fa fa-info-circle fa-fw"></i> <span class="network-name">Conocer Más</span>
                            </a></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-5 col-sm-6">
                ...
                <h2 class="section-heading">Acercade de: <br>El Sistema de Gestión de Objetos de Aprendizaje</h2>
                <p class="lead text-justify"> El Sistema de Gestión de Objetos de Aprendizaje tiene como objetivo desarrollar una aplicación informática que apoye a la construcción,
            ...
            <div class="col-lg-5 col-lg-offset-2 col-sm-6">
                <img class="img-responsive" src="images/Internet.jpg" alt="">
            </div>
        </div>
